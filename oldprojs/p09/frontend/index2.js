...
var CompanyFuncs_Cls = (function () {
    ...
    CompanyFuncs_Cls.prototype.save_Company_Entry = function () {
    ...
    CompanyFuncs_Cls.prototype.renderOutput = function (companies) {
        var _this = this;
    ...
    CompanyFuncs_Cls.prototype.openEditModal = function (itemId) {
        $.ajax({
            url: "http://127.0.0.1:5300/api/contact",
            method: "GET",
            dataType: null,
    ...
    CompanyFuncs_Cls.prototype.openNewEntryModal = function () {
        var idEl = document.getElementById("id_company");
        var el1 = document.getElementById("input_company_name");
        idEl.value = "0";
        el1.value = "";
    ...
    CompanyFuncs_Cls.prototype.refreshCompanies = function () {
        ...
        $.ajax({
            ...
            success: function (companiesOnServer) {
                _this.renderOutput(companiesOnServer);
            },
            error: function (xhr, status, error) {
                console.error("Error fetching contacts:", error);
            }
...
$(function () {
    ...
    btnSaveEl_Company.onclick = function () {
        companyFuncs.save_Company_Entry();
    };
